...
export class RoleListComponent implements OnInit {
  ...
  useCreate = (dialog: NbDialogRef<any>, data: RoleVM) => {
  ...
  useUpdate = (dialog: NbDialogRef<any>, data: RoleVM, index: number) => {
  ...
  useAction = (action: ActionMenuItem, template: TemplateRef<any>, data: RoleVM, index: number) => {
    switch (action.value) {
      case 'edit':
