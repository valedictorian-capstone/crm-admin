...
@Component({
  selector: 'app-role-datatable-item',
  templateUrl: './role-datatable-item.component.html',
  styleUrls: ['./role-datatable-item.component.scss']
})
export class RoleDatatableItemComponent {
