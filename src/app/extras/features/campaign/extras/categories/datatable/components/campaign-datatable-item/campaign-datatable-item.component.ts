...
@Component({
  selector: 'app-campaign-datatable-item',
  templateUrl: './campaign-datatable-item.component.html',
  styleUrls: ['./campaign-datatable-item.component.scss']
})
export class CampaignDatatableItemComponent implements OnDestroy {
