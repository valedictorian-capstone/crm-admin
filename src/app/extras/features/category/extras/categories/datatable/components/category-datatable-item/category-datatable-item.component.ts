...
@Component({
  selector: 'app-category-datatable-item',
  templateUrl: './category-datatable-item.component.html',
  styleUrls: ['./category-datatable-item.component.scss']
})
export class CategoryDatatableItemComponent {
