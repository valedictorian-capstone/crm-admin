...
@Component({
  selector: 'app-deal-datatable-item',
  templateUrl: './deal-datatable-item.component.html',
  styleUrls: ['./deal-datatable-item.component.scss']
})
export class DealDatatableItemComponent {
