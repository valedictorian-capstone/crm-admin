...
@Component({
  selector: 'app-support-pagination',
  templateUrl: './support-pagination.component.html',
  styleUrls: ['./support-pagination.component.scss']
})
export class SupportPaginationComponent {
