...
@Component({
  selector: 'app-attachment-datatable-item',
  templateUrl: './attachment-datatable-item.component.html',
  styleUrls: ['./attachment-datatable-item.component.scss']
})
export class AttachmentDatatableItemComponent implements OnDestroy, OnInit {
