...
@Component({
  selector: 'app-attachment-pagination',
  templateUrl: './attachment-pagination.component.html',
  styleUrls: ['./attachment-pagination.component.scss']
})
export class AttachmentPaginationComponent {
