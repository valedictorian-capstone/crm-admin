...
@Component({
  selector: 'app-product-datatable-item',
  templateUrl: './product-datatable-item.component.html',
  styleUrls: ['./product-datatable-item.component.scss']
})
export class ProductDatatableItemComponent {
