...
@Component({
  selector: 'app-activity-pagination',
  templateUrl: './activity-pagination.component.html',
  styleUrls: ['./activity-pagination.component.scss']
})
export class ActivityPaginationComponent {
