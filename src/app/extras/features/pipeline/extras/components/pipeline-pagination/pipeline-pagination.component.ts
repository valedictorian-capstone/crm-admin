...
@Component({
  selector: 'app-pipeline-pagination',
  templateUrl: './pipeline-pagination.component.html',
  styleUrls: ['./pipeline-pagination.component.scss']
})
export class PipelinePaginationComponent {
